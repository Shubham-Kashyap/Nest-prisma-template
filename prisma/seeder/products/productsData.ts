export const products = [
    {
        ...
        specifications: [
            {
                title: 'Display',
                description: '6.5-inch Super AMOLED display, 1080 x 2400 pixels resolution'
            },
            {
                title: 'Processor',
                description: 'Octa-core Snapdragon 765G'
            },
            {
                title: 'RAM',
                description: '8GB RAM'
            ...
            {
                title: 'Storage',
                description: '128GB internal storage, expandable up to 512GB'
            },
            {
                title: 'Camera',
                description: 'Quad-camera setup: 48MP main, 8MP ultra-wide, 5MP depth, 2MP macro'
            },
            {
                title: 'Battery',
                description: '4500mAh battery with fast charging'
            }
        ],
        highlights: [
            {
                title: 'Powerful Performance',
                description: 'Octa-core Snapdragon 765G processor for smooth and efficient performance.'
            },
            {
                title: 'Impressive Camera',
                description: 'Quad-camera setup for stunning photos and videos in various scenarios.'
            },
            {
                title: 'Long-lasting Battery',
                description: '4500mAh battery ensures all-day usage without constant recharging.'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        specifications: [
            {
                title: 'Display',
                description: 'Bigger Super AMOLED display, 1080 x 2400 pixels resolution'
            },
            {
                title: 'Processor',
                description: 'Octa-core Snapdragon 765G'
    ...
    },
    {
        ...
        highlights: [
            {
                title: 'Radiant Glow',
                description: 'Enhances skin radiance and provides a healthy, glowing complexion.'
            },
            {
                title: 'Cruelty-Free',
                description: 'Not tested on animals, ensuring a cruelty-free beauty regime.'
            },
            {
        ...
        specifications: [
            {
                title: 'Ingredients',
                description: 'Natural and organic ingredients for a gentle and effective skincare experience.'
            },
            {
                title: 'Skin Type',
                description: 'Suitable for all skin types, including sensitive, oily, dry, and combination skin.'
            },
            {
                title: 'Usage',
                description: 'Directions for best use and application to achieve optimal results.'
            },
            {
                title: 'Volume',
                description: 'Available in 50ml, 100ml, and 200ml variants.'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        specifications: [
            {
                title: 'Ingredients',
                description: 'List of primary ingredients used in the product.'
            },
            {
                title: 'Net Weight',
                description: 'Weight of the product, typically specified in grams or kilograms.'
            },
            {
                title: 'Shelf Life',
                description: 'Duration the product remains safe and suitable for consumption.'
            },
            {
                title: 'Storage Instructions',
                description: 'Recommended storage conditions to maintain product freshness.'
            }
        ],
        highlights: [
            {
                title: 'Organic',
                description: 'Made from organic and natural ingredients without synthetic additives.'
            },
            {
                title: 'Gluten-Free',
                description: 'Suitable for individuals with gluten intolerance or celiac disease.'
            },
            {
                title: 'Non-GMO',
                description: 'Does not contain genetically modified organisms.'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        specifications: [
            {
                title: 'Material',
                description: 'Primary material used in the construction of the product.'
            },
            {
                title: 'Dimensions',
                description: 'Product size and dimensions for fitting and placement.'
            },
            {
                title: 'Weight',
                description: 'The weight of the product, typically specified in kilograms or pounds.'
            },
            {
                title: 'Color Options',
                description: 'Variety of colors the product is available in.'
            }
        ],
        highlights: [
            {
                title: 'Eco-Friendly',
                description: 'Made from sustainable and eco-friendly materials.'
            },
            {
                title: 'Easy Assembly',
                description: 'Simple and hassle-free assembly process for convenience.'
            },
            {
                title: 'Multi-Functional',
                description: 'Versatile usage options, serving multiple purposes in the home.'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        specifications: [
            {
                title: 'Material',
                description: 'Primary material used in the construction of the furniture.'
            },
            {
                title: 'Dimensions',
                description: 'Product size and dimensions for fitting and placement.'
            },
            {
                ...
                description: 'Maximum weight the furniture can safely support.'
            },
            {
                title: 'Assembly Required',
                description: 'Indicates whether assembly is required and the complexity involved.'
            }
        ],
        highlights: [
            {
                title: 'Modern Design',
                description: 'Contemporary and stylish design, suitable for modern interiors.'
            },
            {
                title: 'Durable Construction',
                description: 'Sturdy and durable construction for long-lasting use.'
            },
            {
                title: 'Elegant Finishing',
                description: 'Elegant finishing that enhances the overall aesthetic of the furniture.'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        specifications: [
            {
                title: 'Material',
                description: 'Primary material used in the fashion product.'
            },
            {
                title: 'Size',
            ...
            },
            {
                ...
                description: 'Recommended care instructions for maintaining the product.'
            }
        ],
        highlights: [
            {
                title: 'Trendy Design',
                description: 'Fashionable and on-trend design, perfect for modern styles.'
            },
            {
                title: 'Comfortable Fit',
                description: 'Designed for a comfortable and easy fit for everyday wear.'
            },
            {
                title: 'Versatile Style',
                description: 'Versatile style that can be dressed up or down for various occasions.'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        specifications: [
            {
                title: 'Type',
                description: 'The type or category of the appliance (e.g., refrigerator, washing machine).'
            },
            {
                title: 'Power Consumption',
                description: 'Energy usage measured in watts or kilowatt-hours (kWh).'
            },
            {
                title: 'Capacity',
                description: 'The maximum amount the appliance can hold or process.'
            },
            {
                title: 'Dimensions',
                description: 'Product size and dimensions for fitting and placement.'
        ...
        highlights: [
            {
                ...
                description: 'Designed to minimize energy consumption and reduce utility bills.'
            },
            {
                title: 'Easy to Use',
                description: 'Simple and intuitive interface for ease of operation and control.'
            },
            {
                title: 'Multiple Settings',
                description: 'Offers various settings and features to suit different needs and preferences.'
            }
        ]
    },
    {
